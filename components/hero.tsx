...
const Hero = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 p-4 lg:p-20 bg-sky-100">
      <div className="mt-20">
        <h1 className="text-5xl lg:text-7xl font-bold mb-4">Lagos <br /> First Choice in Dry Cleaning</h1>
